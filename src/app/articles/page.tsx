            ...
            <div className="flex flex-col
                ...
                <details className="mt-[10px]">
                    ...
                    <ul className="list-disc pl-5 text-[#313131]">
                        <li className="hover:text-red-600"><a href="#anchor1" className="text-[#313131] hover:text-red-600">タイトル1</a></li>
                        <li className="hover:text-red-600"><a href="#anchor2" className="text-[#313131] hover:text-red-600">タイトル2</a></li>
